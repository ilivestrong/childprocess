 ...
 * 
 * If fork() is used with 'silent:true', then child process's 'stdin', 'stdout' and 'stderror' are piped to the parent.
 * This means parent process's output is disabled on console.
 * These are then available on 'stdin', 'stdout' and 'stderror' streams on child process object and can be consumed via 'data' event listener. 
 */
